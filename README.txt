These are all the features and commands (syntax) for our custom CLI
...
Here's an expanded summary of the syntax:
...
- sort date
- sort type
- compress <file_or_folder>
- chmod <file_name> 777/ 644/ 544/ 664/ 554/ 711
